...
public class RoundedBarChartRendererPres extends BarChartRenderer {
    ...
    // Feste Farben:
    private final int colorCyan  = Color.parseColor("#949FFF");
    private final int colorWhite = Color.WHITE;

    public RoundedBarChartRendererPres(
