...
public class FillerWordAdjustmentPresentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(FillerWordAdjustmentPresentation.this, DeviceSelectionPresentationActivity.class);
        ...
        homeButton.setOnClickListener(v -> {
            Intent intent = new Intent(FillerWordAdjustmentPresentation.this, MainActivity.class);
            startActivity(intent);
        ...
        findViewById(R.id.startMicrophone).setOnClickListener(v -> {
            if (selectedWords.isEmpty()) {
                ...
                Intent intent = new Intent(FillerWordAdjustmentPresentation.this, FillerWordActivityPresentation.class);
                intent.putStringArrayListExtra("SELECTED_WORDS", selectedWords);
                intent.putExtra("useWatchVibration", useWatchVibration);
                startActivity(intent);
            }
        });
    }
    ...
    private void toggleWordSelection(String word, Button button) {
        if (selectedWords.contains(word)) {
            ...
            button.setBackgroundResource(R.drawable.rounded_button_lila);
            button.setTextColor(Color.WHITE);
        }
    }
