...
public class AudioVisualizerViewTraining extends View {
    ...
    public AudioVisualizerViewTraining(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        paintLine.setColor(Color.parseColor("#00CADD"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paintCircle.setColor(highlightRed ? Color.RED : Color.parseColor("#00CADD"));
        ...
        paintLine.setColor(highlightRed ? Color.RED : Color.parseColor("#00CADD"));
        for (int i = 0; i < 3; i++) {
        ...
        paintCircle.setStyle(Paint.Style.FILL);
        paintCircle.setColor(highlightRed ? Color.RED : Color.parseColor("#9AF2FB"));
