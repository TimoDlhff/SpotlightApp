...
public class CircularProgressViewPresentation extends View {
    ...
    public CircularProgressViewPresentation(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        ...
        progressPaint.setColor(0xFF949FFF); // Lila
